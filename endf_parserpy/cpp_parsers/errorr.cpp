...
// MD5 hash of file content below this line: acb306ef421c7c9a962724b31b723ebc
...
py::dict parse_recipe_1aa496513dcfa026_istream(std::istream& cont, ParsingOptions& parse_opts);
py::dict parse_recipe_7f60f82614e2c4ad_istream(std::istream& cont, ParsingOptions& parse_opts);
py::dict parse_recipe_fd7b6b53d7fe662e_istream(std::istream& cont, ParsingOptions& parse_opts);
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_1aa496513dcfa026_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_7f60f82614e2c4ad_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_fd7b6b53d7fe662e_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
...
py::dict parse_mf1mt451(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_1aa496513dcfa026_istream(iss, parse_opts);
}

py::dict parse_mf3(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_7f60f82614e2c4ad_istream(iss, parse_opts);
}

py::dict parse_mf33(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_fd7b6b53d7fe662e_istream(iss, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_1aa496513dcfa026_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_7f60f82614e2c4ad_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_fd7b6b53d7fe662e_istream(inpfile, parse_opts);
}
...
void write_recipe_1aa496513dcfa026_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
void write_recipe_7f60f82614e2c4ad_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
void write_recipe_fd7b6b53d7fe662e_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
    ...
    for (auto mt_key : sorted_mt_keys) {
      ...
      if (mf == 0 && mt == 0) {
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_1aa496513dcfa026_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_7f60f82614e2c4ad_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_fd7b6b53d7fe662e_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
...
std::string write_mf1mt451(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_1aa496513dcfa026_ostream(oss, endf_dict, write_opts);
  return oss.str();
}

std::string write_mf3(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_7f60f82614e2c4ad_ostream(oss, endf_dict, write_opts);
  return oss.str();
}

std::string write_mf33(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_fd7b6b53d7fe662e_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
void write_mf1mt451_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_1aa496513dcfa026_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf3_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_7f60f82614e2c4ad_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf33_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_fd7b6b53d7fe662e_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
