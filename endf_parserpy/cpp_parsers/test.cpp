...
// MD5 hash of file content below this line: e39b40f3d686888138def8beda663274
...
py::dict parse_recipe_e2c332113e30b35d_istream(std::istream& cont, ParsingOptions& parse_opts);
py::dict parse_recipe_5fcc5b03fa02a5ec_istream(std::istream& cont, ParsingOptions& parse_opts);
py::dict parse_recipe_7536ac5315eb4fc7_istream(std::istream& cont, ParsingOptions& parse_opts);
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict[py::cast(mt)] = parse_recipe_7536ac5315eb4fc7_istream(cont, parse_opts);
        }
      } else {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_5fcc5b03fa02a5ec_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_e2c332113e30b35d_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
...
py::dict parse_mf1mt1(std::string& strcont, ParsingOptions parse_opts) {
  ...
  return parse_recipe_e2c332113e30b35d_istream(iss, parse_opts);
}

py::dict parse_mf1mt2(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_5fcc5b03fa02a5ec_istream(iss, parse_opts);
}

py::dict parse_mf1mt3(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_7536ac5315eb4fc7_istream(iss, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_e2c332113e30b35d_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_5fcc5b03fa02a5ec_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_7536ac5315eb4fc7_istream(inpfile, parse_opts);
}
...
void write_recipe_e2c332113e30b35d_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
void write_recipe_5fcc5b03fa02a5ec_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
void write_recipe_7536ac5315eb4fc7_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
    ...
    for (auto mt_key : sorted_mt_keys) {
      ...
      if (mf == 1 && mt == 3) {
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_7536ac5315eb4fc7_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_5fcc5b03fa02a5ec_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_e2c332113e30b35d_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
...
std::string write_mf1mt1(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_e2c332113e30b35d_ostream(oss, endf_dict, write_opts);
  return oss.str();
}

std::string write_mf1mt2(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_5fcc5b03fa02a5ec_ostream(oss, endf_dict, write_opts);
  return oss.str();
}

std::string write_mf1mt3(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_7536ac5315eb4fc7_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
void write_mf1mt1_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_e2c332113e30b35d_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf1mt2_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_5fcc5b03fa02a5ec_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf1mt3_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_7536ac5315eb4fc7_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
