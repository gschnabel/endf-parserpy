...
// MD5 hash of file content below this line: 3836f8b5926e948479580d17b60422d9
...
py::dict parse_recipe_6208bc81f5ed50f8_istream(std::istream& cont, ParsingOptions& parse_opts);
...
py::dict parse_recipe_cf135123f8d9c8cb_istream(std::istream& cont, ParsingOptions& parse_opts);
py::dict parse_recipe_e893c1e5d9653907_istream(std::istream& cont, ParsingOptions& parse_opts);
py::dict parse_recipe_abfa0647b7f094a0_istream(std::istream& cont, ParsingOptions& parse_opts);
...
py::dict parse_recipe_840bb9e371da217c_istream(std::istream& cont, ParsingOptions& parse_opts);
...
py::dict parse_recipe_1fcb821fdc628b12_istream(std::istream& cont, ParsingOptions& parse_opts);
...
py::dict parse_recipe_0c1545cdc402f9ff_istream(std::istream& cont, ParsingOptions& parse_opts);
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_6208bc81f5ed50f8_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_e893c1e5d9653907_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_cf135123f8d9c8cb_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_abfa0647b7f094a0_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_840bb9e371da217c_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_1fcb821fdc628b12_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
      ...
      if (should_parse_section(mf, mt, exclude, include)) {
        {
          ...
          curdict = curdict[py::cast(mf)];
          curdict[py::cast(mt)] = parse_recipe_0c1545cdc402f9ff_istream(cont, parse_opts);
        }
      } else {
        verbatim_section = read_section_verbatim(mat, mf, mt, cont, is_firstline, parse_opts);
        {
...
py::dict parse_mf1mt451(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_6208bc81f5ed50f8_istream(iss, parse_opts);
}
...
py::dict parse_mf2mt152(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_cf135123f8d9c8cb_istream(iss, parse_opts);
}

py::dict parse_mf2mt153(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_e893c1e5d9653907_istream(iss, parse_opts);
}

py::dict parse_mf3(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_abfa0647b7f094a0_istream(iss, parse_opts);
}
...
py::dict parse_mf6(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_840bb9e371da217c_istream(iss, parse_opts);
}
...
py::dict parse_mf8mt457(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_1fcb821fdc628b12_istream(iss, parse_opts);
}
...
py::dict parse_mf23(std::string& strcont, ParsingOptions parse_opts) {
  std::istringstream iss(strcont);
  return parse_recipe_0c1545cdc402f9ff_istream(iss, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_6208bc81f5ed50f8_istream(inpfile, parse_opts);
}
...
py::dict parse_mf2mt152_file(std::string& filename, ParsingOptions parse_opts) {
  std::ifstream inpfile(filename, std::ios::binary);
if ((! inpfile.is_open())) {
  throw std::ifstream::failure("failed to open file " + filename);
}
  return parse_recipe_cf135123f8d9c8cb_istream(inpfile, parse_opts);
}

py::dict parse_mf2mt153_file(std::string& filename, ParsingOptions parse_opts) {
  std::ifstream inpfile(filename, std::ios::binary);
if ((! inpfile.is_open())) {
  throw std::ifstream::failure("failed to open file " + filename);
}
  return parse_recipe_e893c1e5d9653907_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_abfa0647b7f094a0_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_840bb9e371da217c_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_1fcb821fdc628b12_istream(inpfile, parse_opts);
}
...
if ((! inpfile.is_open())) {
  ...
  return parse_recipe_0c1545cdc402f9ff_istream(inpfile, parse_opts);
}
...
void write_recipe_6208bc81f5ed50f8_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
...
void write_recipe_cf135123f8d9c8cb_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
void write_recipe_e893c1e5d9653907_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
void write_recipe_abfa0647b7f094a0_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
...
void write_recipe_840bb9e371da217c_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
...
void write_recipe_1fcb821fdc628b12_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
...
void write_recipe_0c1545cdc402f9ff_ostream(std::ostream& cont, py::dict endf_dict, WritingOptions& write_opts);
    ...
    for (auto mt_key : sorted_mt_keys) {
      ...
      if (mf == 0 && mt == 0) {
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_6208bc81f5ed50f8_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_e893c1e5d9653907_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_cf135123f8d9c8cb_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_abfa0647b7f094a0_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_840bb9e371da217c_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_1fcb821fdc628b12_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
        ...
        if (py::isinstance<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)])) {
          ...
          write_recipe_0c1545cdc402f9ff_ostream(cont, py::cast<py::dict>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        } else {
          write_section_verbatim(cont, py::cast<py::list>(endf_dict[py::cast(mf)][py::cast(mt)]), write_opts);
        }
        mat = get_mat_from_mfmt_section(mt_dict);
...
std::string write_mf1mt451(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_6208bc81f5ed50f8_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
std::string write_mf2mt152(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_cf135123f8d9c8cb_ostream(oss, endf_dict, write_opts);
  return oss.str();
}

std::string write_mf2mt153(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_e893c1e5d9653907_ostream(oss, endf_dict, write_opts);
  return oss.str();
}

std::string write_mf3(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_abfa0647b7f094a0_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
std::string write_mf6(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_840bb9e371da217c_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
std::string write_mf8mt457(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_1fcb821fdc628b12_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
std::string write_mf23(py::dict endf_dict, WritingOptions write_opts) {
  std::ostringstream oss;
  write_recipe_0c1545cdc402f9ff_ostream(oss, endf_dict, write_opts);
  return oss.str();
}
...
void write_mf1mt451_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_6208bc81f5ed50f8_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf2mt152_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  std::ofstream outfile(filename, std::ios::binary);
  if ((! outfile.is_open())) {
    throw std::ofstream::failure("failed to open file " + filename);
  }
  write_recipe_cf135123f8d9c8cb_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}

void write_mf2mt153_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  std::ofstream outfile(filename, std::ios::binary);
  if ((! outfile.is_open())) {
    throw std::ofstream::failure("failed to open file " + filename);
  }
  write_recipe_e893c1e5d9653907_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf3_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_abfa0647b7f094a0_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf6_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_840bb9e371da217c_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf8mt457_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_1fcb821fdc628b12_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
...
void write_mf23_file(std::string& filename, py::dict endf_dict, WritingOptions write_opts) {
  ...
  write_recipe_0c1545cdc402f9ff_ostream(outfile, endf_dict, write_opts);
  outfile.close();
}
